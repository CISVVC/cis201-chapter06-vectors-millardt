...
void add_transactions(Transactionlog &tlog)
{
    ...
    tlog.add_transaction(Transaction(2,10));
    tlog.add_transaction(Transaction(3,15));
    ...
    tlog.add_transaction(Transaction(29,1));
    tlog.add_transaction(Transaction(30,1)); //30 10
